...
var (
	...
	QlSumNodesResourceCapacityFromCluster    = "sum(" + values.NodeResourceCapacityMetricsName + "{cluster_id='%s',resource='%s'})"
	...
	QlSumNodesResourceAllocatableFromCluster = "sum(" + values.NodeResourceAllocatableMetricsName + "{cluster_id='%s',resource='%s'})"
	...
	QlResourceCapacity = "sum(" + values.NodeResourceCapacityMetricsName + ") by (cluster_id,resource)"
	...
	QlResourceCapacityFromCluster = "sum(" + values.NodeResourceCapacityMetricsName + "{cluster_id='%s'}) by (resource)"
